RegisterNetEvent('srp-heists:checkAvailability')
AddEventHandler('srp-heists:checkAvailability', function() 
    ...
    exports["srp-interface"]:showContextMenu(FatCunt)
end)

RegisterNetEvent('srp-heists:purchaseHeistEquipment')
AddEventHandler('srp-heists:purchaseHeistEquipment', function()
    local HeistEquipment = {
		{
            ...
            children = {
                ...
                action = "srp-heists:purchaseGreenLaptop",
            },
        },
        {
            title = "Paleto Laptop",
            ...
            children = {
                ...
                action = "srp-heists:purchaseBlueLaptop",
            },
        },
    }
...
RegisterInterfaceCallback('srp-heists:purchaseGreenLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['srp-inventory']:hasEnoughOfItem('heistusb5', 1) then
        TriggerEvent('inventory:removeItem', 'heistusb5', 1)
        TriggerEvent("player:receiveItem", "heistlaptop3", 1)
    end
end)

RegisterInterfaceCallback('srp-heists:purchaseBlueLaptop', function(data, cb)
    cb({ data = {}, meta = { ok = true, message = '' } })
    if exports['srp-inventory']:hasEnoughOfItem('heistusb1', 1) then
