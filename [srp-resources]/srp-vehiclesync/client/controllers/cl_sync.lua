...
function SetEngineSound(pVehicle)
    local sound = exports['srp-vehicles']:GetVehicleAfterMarket(pVehicle, 'engineSound')
...
function RequestSyncStateUpdate(pVehicle)
    ...
    Citizen.SetTimeout(50, function()
        ...
        TriggerServerEvent('srp-vehicleSync:updateSyncState', netId, syncState)
    end)
end
...
RegisterNetEvent('srp-vehicleSync:updateSyncState')
AddEventHandler('srp-vehicleSync:updateSyncState', function(pNetId, pSyncState)
...
RegisterNetEvent('srp-vehicles:spawnedGarageVehicle')
AddEventHandler('srp-vehicles:spawnedGarageVehicle', function(pNetId, pModel)
    Citizen.Wait(1000)
    ...
    local afterMarkets = exports['srp-vehicles']:GetVehicleAfterMarket(vehicle)
...
Citizen.CreateThread(function()
    exports["srp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Neon Lights", "+toggleNeonLights", "-toggleNeonLights")
    exports["srp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Right)", "+toggleRightIndicator", "-toggleRightIndicator")
    exports["srp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Left)", "+toggleLeftIndicator", "-toggleLeftIndicator")
    exports["srp-keybinds"]:registerKeyMapping("", "Vehicle", "Toggle Light Indicator (Hazard)", "+toggleHazardLights", "-toggleHazardLights")
end)