...
PedEntries[#PedEntries+1] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and ((exports["srp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
    end
}
...
PedEntries[#PedEntries+1] = {
  ...
  isEnabled = function(pEntity, pContext)
    return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and (isPolice) and pContext.distance <= 1.2
  end
}
...
PedEntries[#PedEntries+1] = {
    ...
    subMenus = {"police:frisk", "police:search", "police:remmask", "peds:cuff","peds:uncuff", "police:fingerprint", "police:gsr", "peds:escort" },
    isEnabled = function(pEntity, pContext)
        return (isPolice)
      end
  }

MenuItems['peds:escort'] = {
    data = {
        id = "peds-escort",
...
MenuItems['peds:cuff'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["srp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
        --return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and not pContext.flags['isCuffed'] and ((exports["srp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc))) and pContext.distance <= 1.2
    end
}
...
MenuItems['peds:uncuff'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["srp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
        --return not IsDisabled() and pEntity and pContext.flags['isPlayer'] and pContext.flags['isCuffed'] and ((exports["srp-inventory"]:hasEnoughOfItem("cuffs",1,false) or (isPolice or isDoc)))
    end
}
...
MenuItems['cuffs:blindfold'] = {
    ...
    isEnabled = function(pEntity, pContext)
        return not isDead and ((exports["srp-inventory"]:hasEnoughOfItem("blindfold",1,false)))
        --return not IsDisabled() and pEntity and pContext.flags['isCuffed'] and pContext.flags['isPlayer'] and not pContext.flags['isBlindfolded'] and ((exports["srp-inventory"]:hasEnoughOfItem("blindfold",1,false)))
    end
}
...
MenuItems['cuffs:gag'] = {
  ...
  isEnabled = function(pEntity, pContext)
      return not isDead and ((exports["srp-inventory"]:hasEnoughOfItem("gag_sock",1,false)))
      --return not IsDisabled() and pEntity and pContext.flags['isCuffed'] and pContext.flags['isPlayer'] and not pContext.flags['isGagged'] and ((exports["srp-inventory"]:hasEnoughOfItem("gag_sock",1,false)))
  end
}
...
RegisterNetEvent('srp-mdw:open-mdw')
AddEventHandler('srp-mdw:open-mdw', function()
    ExecuteCommand('+mdw')
end)