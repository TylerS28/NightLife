...
isEnabled = function(pEntity, pContext)
    return not IsDisabled() and IsPedInAnyVehicle(PlayerPedId(), false) and exports['srp-vehicles']:hasKey(GetVehicleNumberPlateText(GetVehiclePedIsIn(PlayerPedId()))) 
end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      id = "srp-garages:pd_heli",
      title = "Vehicle List",
      icon = "#vehicle-vehicleList",
      event =  "srp-garages:pd_heli" 
  },
  isEnabled = function()
...
-- --         event = "srp-doors:doorKeyFob"
-- --     },
-- --     isEnabled = function(pEntity, pContext)
-- --         return not IsDisabled() and IsPedInAnyVehicle(PlayerPedId(), false) and exports["srp-inventory"]:hasEnoughOfItem("keyfob", 1, false)
-- --     end
-- -- }
...
--   },
--   isEnabled = function(pEntity, pContext)
--       return not IsDisabled() and polyChecks.vanillaUnicorn.isInside and not exports["srp-flags"]:HasPedFlag(PlayerPedId(), 'isPoledancing')
--   end
-- }
...
--   },
--   isEnabled = function(pEntity, pContext)
--       return not IsDisabled() and polyChecks.vanillaUnicorn.isInside and exports["srp-flags"]:HasPedFlag(PlayerPedId(), 'isPoledancing')
--   end
-- }
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    event = "srp-garages:store"
},
isEnabled = function()
  return isAtGarage and exports["srp-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
} 
...
isEnabled = function()
  return exports["srp-garages"]:atShared() and exports["srp-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
...
isEnabled = function()
  return isAtHouseGarage and exports["srp-garages"]:NearVehicle("Distance") and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
}]]
 ...
 GeneralEntries[#GeneralEntries+1] = {
   data = {
     ...
     title = "Get up",
     icon = "#obj-chair",
     event = "srp-emotes:sitOnChair"
   },
   isEnabled = function(pEntity, pContext)
     return not isDead and exports["srp-flags"]:HasPedFlag(PlayerPedId(), 'isSittingOnChair')
   end
 }
...
--       event = "srp-housing:rent"
--   },
--   isEnabled = function(pEntity, pContext)
--       return not isDead and exports["srp-housing"]:canRent()
--   end
-- }
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      icon = "#property-enter",
      event = "srp-housing:enterBUILDINGCMON",
      parameters = false,
  },
  isEnabled = function(pEntity, pContext)
      local isNear, propertyId = exports["srp-housing"]:isNearProperty()
...
GeneralEntries[#GeneralEntries+1] = {
  ...
  isEnabled = function(pEntity, pContext)
      local isNear, propertyId = exports["srp-housing"]:isNearProperty()
      return not isDead and isNear and exports["srp-housing"]:isBeingRobbed(propertyId)
  end
}
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      title = "Sell",
      icon = "#walking",
      event = "srp-meth:cornerSellProduct",
  },
  isEnabled = function(pEntity, pContext)
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
      ...
      title = "Corner",
      icon = "#walking",
      event = "srp-meth:cornerStartSelling",
  },
  isEnabled = function(pEntity, pContext)
...
GeneralEntries[#GeneralEntries+1] = {
  data = {
    ...
    title = "Vehicle List",
    icon = "#vehicle-vehicleList",
    event = "srp-garages:open2"
},
isEnabled = function()
 print(exports['srp-housing']:ownsThisHouseHmm())
  return isAtHouseGarage and not IsPedInAnyVehicle(PlayerPedId(), false) and not isDead
end
}
...
-- -- end)
 ...
 AddEventHandler("vehicle:openRifleRack", function()
	...
	if exports["isPed"]:isPed("myJob") == 'police' or exports["isPed"]:isPed("myJob") == 'sheriff' or exports["isPed"]:isPed("myJob") == 'ranger' or exports["isPed"]:isPed("myJob") == 'state' then
		local finished = exports["srp-taskbar"]:taskBar(1000,"Unlocking...",false,true)
...
AddEventHandler("srp-menu:dashCamAttached", function(pVehicleNetId, pEnabled)
