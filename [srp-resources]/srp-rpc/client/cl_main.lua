...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('srp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('srp-rpc:cl_response')
AddEventHandler('srp-rpc:cl_response', function(origin, callId, response)
