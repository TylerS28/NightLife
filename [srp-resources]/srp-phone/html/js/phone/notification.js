...
btnGasAccept = () => {
	...
	if (gasType == "gas") { 
		$.post("https://srp-phone/purchase_gas", JSON.stringify({}))
	} else if (gasType == "charge") {
		$.post("https://srp-phone/acceptBusinessCharge", JSON.stringify({
			pAmount: chargeAMT,
			pBID: companyID,
			pTargetID: targetID,
			pSenderID: senderIDX
		...
		$.post("https://srp-phone/purchaseCar", JSON.stringify({
			//plate: plate,
			amount: amount,
			senderID: sellerIDc,
		}))
        ...
        $.post("https://srp-phone/accept_tow_job", JSON.stringify({}))
    } else if (gasType == "jobofferdelivery") {
        $.post("https://srp-phone/accept_delivery_job", JSON.stringify({}))
    } else if (gasType == "jobofferdodo") {
        $.post("https://srp-phone/accept_dodo_job", JSON.stringify({}))
    } else if (gasType == "house_robbery") {
        $.post("https://srp-phone/accept_house_robbery", JSON.stringify({}))
    } else if (gasType == "jobofferoxy") {
        $.post("https://srp-phone/accept_oxy_run", JSON.stringify({}))
	} else if (gasType == "jobofferchop") {
        $.post("https://srp-phone/accept_chop_shop", JSON.stringify({}))
	} else if (gasType == "documents") {
		$.post("https://srp-phone/acceptDocumentReceiveRequest", JSON.stringify({
		...
		$.post("https://srp-phone/onPlayerJoinBankBusters", JSON.stringify({
...
btnJobAccept = () => {
	...
	$.post("https://srp-phone/jobOfferAccepted", JSON.stringify({
	}))
}
