RPC.register("srp-phone:submitNewEventDiamondSports", function(pSource, pEventName, pEventLocation, pTimeZone, pEventTimeHr, pEventTimeMin, pEventDate)
...
RPC.register("srp-phone:getDiamondSportsEvents", function(pSource)
...
RPC.register("srp-phone:deleteDiamondEvent", function(pSource, pID)
