...
RegisterNUICallback('wenmoSubmit', function(data)
    ...
    TriggerServerEvent('srp-phone:transferWenmo',num,amount,comment)
end)

RegisterNUICallback("srp-phone:getWenmo", function(data, cb)
    local success, message = RPC.execute("srp-phone:getWenmo")
    local wenmo = {}
