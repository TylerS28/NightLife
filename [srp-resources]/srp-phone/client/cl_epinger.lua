...
RegisterNUICallback("srp-ui:pingSend", function(data, cb)
...
RegisterNUICallback("srp-ui:pingAccept", function(data, cb)
...
RegisterNUICallback("srp-ui:pingReject", function(data, cb)
