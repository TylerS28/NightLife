RegisterNetEvent('srp-bikerent:menu')
AddEventHandler('srp-bikerent:menu', function()                           
...
RegisterNetEvent('srp-bikerent:checkmoney')
AddEventHandler('srp-bikerent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("srp-bikerent:hasmoney", price, vehicle)

end)

RegisterNetEvent('srp-bikerent:spawnbike')
AddEventHandler('srp-bikerent:spawnbike', function(vehicleName)                            
