...
AddEventHandler("srp-fw:exportsReady", function()
    exports["srp-fw"]:addModule("JobManager", DPX.Jobs)
end)
                ...
                for src,data in pairs(tbl) do
                    ...
                    if user then
                        ...
                        if tonumber(curTime) == tonumber(data.lastPayCheck) or tonumber(data.lastPayCheck) >= 480 then
                            ...
                            --exports["srp-log"]:AddLog("Job Pay", user, "User recieved paycheck, amount: " .. tostring(payCheck))
                        else
...
RPC.register("srp-jobmanager:jobCount", function(pSource, pJob)
