...
Citizen.CreateThread(function()
    ...
    while(true) do
		...
		if addedPolyZone == false then
			    exports["srp-polyzone"]:AddBoxZone("carrent", vector3(110.4619140625, -1090.6267089844, 29.302474975586), 0.8, 0.9, {
				name="carrent",
				heading=331.47,
				debugPoly=false,
				minZ=22.37,
...
--RegisterNetEvent('srp-carrent:menu')
--AddEventHandler('srp-carrent:menu', function()   
...
RegisterNetEvent('srp-carrent:checkmoney')
AddEventHandler('srp-carrent:checkmoney', function(data)                            
        local vehicle = data.car
        local price = data.price
        TriggerServerEvent("srp-carrent:hasmoney", price, vehicle)

end)

RegisterNetEvent('srp-carrent:spawncar')
AddEventHandler('srp-carrent:spawncar', function(vehicleName)                            
