...
Citizen.CreateThread(function()
  exports["srp-keybinds"]:registerKeyMapping("", "Player", "Drop Prop", "+propAttachDrop", "-propAttachDrop")
...
RegisterNetEvent('srp-propattach:attach')
AddEventHandler('srp-propattach:attach', function(pPropItem, pTargetFunction)
