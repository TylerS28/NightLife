...
function syncNative(name, netEntity, options, ...)
    TriggerServerEvent("srp-sync:executeSyncNative", name, netEntity, options, table.pack(...))
end
exports("syncNative", syncNative)

RegisterNetEvent("srp-sync:clientExecuteSyncNative")
AddEventHandler("srp-sync:clientExecuteSyncNative", function(native, netEntity, options, args)
