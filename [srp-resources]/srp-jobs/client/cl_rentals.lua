...
local function returnBoat()
    ...
    local finished = exports["srp-taskbar"]:taskBar(1000, "Returning Boat")
    ...
    TriggerEvent("srp-fishing:currentlyRentedBoat", currentlyRentedBoat)
end

function rentBoat()
    boatsValeted = boatsValeted + 1
    FreezeEntityPosition(PlayerPedId(), true)
    local finished = exports["srp-taskbar"]:taskBar(1000, "Valeting Boat")
...
AddEventHandler("srp-fishing:rentBoat", function(name)
...
AddEventHandler("srp-fishing:returnBoat", function()
