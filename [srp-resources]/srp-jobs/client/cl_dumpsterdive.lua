...
RegisterNetEvent('srp-dumpster')
AddEventHandler('srp-dumpster', function() 
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if (finished == 100) then 
                        ...
                        local finished = exports ['srp-taskbar']:taskBar(25000, 'Searching Dumpster')
                        if (finished ==100) then
                            TriggerServerEvent('qpixel:giveDumpsterReward')
                            TriggerServerEvent('qpixel:startDumpsterTimer', dumpster)
...
RegisterNetEvent('srp-dumpster2')
AddEventHandler('srp-dumpster2', function() 
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
        ...
        if GetDistanceBetweenCoords(pos.x, pos.y, pos.z, dumpPos.x, dumpPos.y, dumpPos.z, true) then
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    TaskPlayAnim(GetPlayerPed(-1), dict, 'base', 3.0, -8, -1, 63, 0, 0, 0, 0 )
                    ::skill::
                    local skillfinished = exports["srp-skillbar"]:taskBar(1)
                    if skillfinished then
                        ...
                        if (finished ==100) then
                            TriggerServerEvent('qpixel:giveDumpsterReward')
                            TriggerServerEvent('qpixel:startDumpsterTimer', dumpster2)
                            FreezeEntityPosition(GetPlayerPed(-1),false)
                            ClearPedTasks(GetPlayerPed(-1))
                        end
...
RegisterNetEvent('srp-dumpster3')
AddEventHandler('srp-dumpster3', function() 
    local ped = GetPlayerPed(-1)
    local pos = GetEntityCoords(ped)
    local dumpsterFound = false
            ...
            for i = 1, #searched do
                ...
                elseif i == #searched and not dumpsterFound then
                    ...
                    if skillfinished then
                        ...
                        local finished = exports ['srp-taskbar']:taskBar(15000, 'Searching Dumpster')
                        if (finished ==100) then
                            TriggerServerEvent('qpixel:giveDumpsterReward')
                            TriggerServerEvent('qpixel:startDumpsterTimer', dumpster3)
                            FreezeEntityPosition(GetPlayerPed(-1),false)
                            ClearPedTasks(GetPlayerPed(-1))
                        end
...
RegisterNetEvent('qpixel:removeDumpster')
AddEventHandler('qpixel:removeDumpster', function(object)
    for i = 1, #searched do
