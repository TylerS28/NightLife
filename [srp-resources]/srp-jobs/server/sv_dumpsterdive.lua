...
RegisterServerEvent('qpixel:startDumpsterTimer')
AddEventHandler('qpixel:startDumpsterTimer', function(dumpster)
    startTimer(source, dumpster)
end)

RegisterServerEvent('qpixel:giveDumpsterReward')
AddEventHandler('qpixel:giveDumpsterReward', function()
...
function startTimer(id, object)
    ...
    while timer > 0 do
        ...
        timer = timer - 1000
        if timer == 0 then
            TriggerClientEvent('qpixel:removeDumpster', id, object)
        end
    end
end