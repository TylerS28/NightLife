...
Citizen.CreateThread(function()
  Wait(10000)
  TriggerServerEvent("srp-fx:setSteamId")
end)
RegisterNetEvent("srp-fix:setSteamIdClient")
AddEventHandler("srp-fix:setSteamIdClient", function(id)
  mySteamId = id
end)
...
--exports["srp-keybinds"]:registerKeyMapping(""","Misc", "Make it Rain", "+makeItRain", "-makeItRain")
