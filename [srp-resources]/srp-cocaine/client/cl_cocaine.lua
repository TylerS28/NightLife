...
RegisterNetEvent("srp-heists:cocaine:failure")
AddEventHandler("srp-heists:cocaine:failure", function ()
...
RegisterNetEvent("srp-heists:cocaine:begin_start")
AddEventHandler("srp-heists:cocaine:begin_start", function ()
    print('Here 3')
...
RegisterNetEvent("srp-heists:cocaine:success:2")
AddEventHandler("srp-heists:cocaine:success:2", function ()
    print('Here 2')
    if not enabled or not eventStarted then
        return
    end
...
RegisterNetEvent("srp-heists:cocaine:success:3")
AddEventHandler("srp-heists:cocaine:success:3", function ()
    print('Here 1')
    if not enabled or not eventStarted then
        return
    end
...
RegisterNetEvent("srp-heists:cocaine:success:4")
AddEventHandler("srp-heists:cocaine:success:4", function ()
...
Citizen.CreateThread(function()
    ...
    -- START EVENT
    exports["srp-polytarget"]:AddBoxZone(
    ...
    exports["srp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "srp-heists:cocaine:failure",
    ...
    exports["srp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
        event = "srp-heists:cocaine:begin_start",
    ...
    exports["srp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
        event = "srp-heists:cocaine:success:2",
    ...
    exports["srp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
        event = "srp-heists:cocaine:success:3",
    ...
    exports["srp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{ -- THIS IS FUCKING SUCCESSSSSSSS
        event = "srp-heists:cocaine:success:4",
    ...
    exports["srp-interact"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{
        event = "srp-heists:cocaine:success:4",
...
RegisterNetEvent("srp-heists:doVehicle", function(pVehicle, x,y,z)
    print(pVehicle)
...
RegisterCommand('cocaine', function()
    ...
    Wait(5500)
    TriggerEvent('srp-heists:cocaine:success:4')
end)