...
function canRent()
    ...
    if isComplete and dist <= 3.0 then
        ...
        local canRent = RPC.execute("srp-housing:canRent", propertyId)
...
AddEventHandler("srp-housing:handler", function(data, cb)
...
Citizen.CreateThread(function()
    exports["srp-keybinds"]:registerKeyMapping("","Housing", "Interact", "+propertyInteract", "-propertyInteract", "E")
