...
RegisterNetEvent("srp-scenes:allScenes")
AddEventHandler("srp-scenes:allScenes", function(scenes)
  activeScenes = scenes
end)

RegisterNetEvent("srp-scenes:refreshScenes")
AddEventHandler("srp-scenes:refreshScenes", function(sceneId, scene)
...
RegisterNetEvent("srp-scenes:deleteScene")
AddEventHandler("srp-scenes:deleteScene", function(removeId)
  if removeId then
...
function calculateScenesToDraw()
  ...
  local isPeekActive = exports['srp-interact']:IsPeeking()
...
RegisterInterfaceCallback("srp-ui:scenes:input", function(data, cb)
...
RegisterCommand("+startScene", function()
  if sceneStarted then
    ...
    exports['srp-interface']:openApplication('textbox', {
      callbackUrl = 'srp-ui:scenes:input',
      key = 1,
      items = {
        {
          icon = "pencil-alt",
...
RegisterCommand("+deleteScene", function()
  ...
  TriggerServerEvent("srp-scenes:deleteScene", GetEntityCoords(PlayerPedId()))
end, false)
RegisterCommand("-deleteScene", function() end, false)

Citizen.CreateThread(function()
  exports["srp-keybinds"]:registerKeyMapping("", "Scenes", "Start / Place Scene", "+startScene", "-startScene")
  exports["srp-keybinds"]:registerKeyMapping("", "Scenes", "Enable / Disable", "+enableScene", "-enableScene")
  exports["srp-keybinds"]:registerKeyMapping("", "Scenes", "Delete Closest Scene", "+deleteScene", "-deleteScene")
  RequestStreamedTextureDict('commonmenu', true)
  Wait(5000)
  TriggerServerEvent("srp-scenes:getScenes")
end)