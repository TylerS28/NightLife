...
function taskBarSkillCheck(difficulty, skillGapSent, cb, reverse, usePrev)
  ...
  local duration = difficulty * (math.min(exports["srp-buffs"]:getAlertLevelMultiplier(), 1.33))
  ...
  exports['srp-actionbar']:disableActionBar(true)
  ...
  SetTimeout(500, function()
    if not tbsListening then
      exports['srp-actionbar']:disableActionBar(false)
