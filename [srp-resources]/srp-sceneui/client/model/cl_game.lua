...
AddEventHandler('srp-config:configReady', function()
    loadPublicData()
end)

function loadPublicData()
    local showWatermark = exports['srp-config']:GetMiscConfig('hud.watermark')
    local showroomPurchase = exports['srp-config']:GetMiscConfig('showrooms.catalog.purchase')
    local skipMdwProfileCheck = exports['srp-config']:GetMiscConfig('mdw.profiles.skip')
    local serverCode = exports["srp-config"]:GetServerCode()
...
-- AddEventHandler("srp-ui:hud:values", function(values)
--   -- sendAppEvent("hud", {
--   --     food = values["hunger"],
