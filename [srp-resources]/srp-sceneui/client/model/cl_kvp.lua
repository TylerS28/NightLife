...
RegisterNUICallback("srp-ui:setKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
  -- data.value = value
  ...
  TriggerEvent("srp-hud:settings", data.key, data.value)
...
RegisterNUICallback("srp-ui:getKVPValue", function(data, cb)
  -- INCOMING
  -- data.key = key
...
function GetPreferences()
  local result = GetResourceKvpString('srp-preferences')
  return json.decode(result or "{}")
end
