...
RegisterNetEvent("srp-sceneui:open-application")
AddEventHandler("srp-sceneui:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("srp-sceneui:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("srp-ui:soundPlay")
AddEventHandler("srp-ui:soundPlay", function(name, volume, loop)
