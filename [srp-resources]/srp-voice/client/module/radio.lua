...
function addPlayerToRadio(plySource)
	TriggerEvent('srp-voice:getRadioChannel')
		...
		if not radioPressed and radioEnabled then
			if radioChannel > 0 then
				...
				Citizen.CreateThread(function()
					TriggerEvent('srp-hud:transmitting', radioPressed)
...
RegisterNetEvent("srp-voice:getRadioChannel")
AddEventHandler("srp-voice:getRadioChannel", function()
	TriggerServerEvent('srp-dispatch:GrabRadioChannel', radioChannel)
end)