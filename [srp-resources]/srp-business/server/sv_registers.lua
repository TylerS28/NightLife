...
RPC.register("srp-business:startPurchase", function(pSource, pData)
    ...
    TriggerClientEvent("srp-business:activePurchase", -1, insert)
end)
...
RPC.register("srp-business:completePurchase", function(pSource, pData)
    ...
    local owner = exports["srp-fw"]:getModule("Player"):GetUser(data.charger)
    ...
    TriggerClientEvent("srp-business:closePurchase", -1, insert)

    TriggerClientEvent('srp-phone:businessRegisterNoti', pSource, "SERVICE CHARGE", message)
