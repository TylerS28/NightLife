...
function startRaceCreation(options)
    ...
    while raceName ~= nil and options.raceName == nil and RPC.execute("srp-racing:isRaceNameTaken", raceName) == true do
...
function finishRaceCreation()
    ...
    TriggerServerEvent("srp-racing:recieveCreateData", raceName, raceType, raceThumbnail, checkpoints)
...
RegisterNetEvent("srp-racing:cmd:racecreate")
AddEventHandler("srp-racing:cmd:racecreate", function(options)
    if GetVehiclePedIsIn(PlayerPedId(), false) ~= 0 then
        startRaceCreation(options)
    end
end)

RegisterNetEvent("srp-racing:cmd:racecreatedone")
AddEventHandler("srp-racing:cmd:racecreatedone", function()
    finishRaceCreation()
end)

RegisterNetEvent("srp-racing:cmd:racecreatecancel")
AddEventHandler("srp-racing:cmd:racecreatecancel", function()
    cancelRaceCreation()
end)
