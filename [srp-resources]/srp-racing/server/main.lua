...
RPC.register("srp-racing:getAllRaces", function(pSrc)
    local src = pSrc
...
RegisterNetEvent('srp-racing:allRaces')
AddEventHandler('srp-racing:allRaces', function()
    local allRaces = {
        races = Races,
        pendingRaces = PendingRaces,
        activeRaces = ActiveRaces,
    ...
    TriggerEvent('srp-phone:allRaces', allRaces) 
end)
...
RPC.register("srp-racing:awardPlayer", function(pSrc, pAmt)
...
Citizen.CreateThread(function()
    ...
    Wait(100)
    TriggerEvent('srp-racing:allRaces')
end)

RPC.register('srp-racing:setAlias', function(src, usedItemIds, usedItemSlots, usedItemMetadatas, aliass)
...
RPC.register('srp-racing:giveRacingUSB', function(pSource)
