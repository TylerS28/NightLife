RegisterNetEvent("srp-racing:recieveCreateData")
AddEventHandler("srp-racing:recieveCreateData", function(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    local src = source
    ...
    TriggerClientEvent("srp-racing:addedRace", -1, {}, Races)
    TriggerClientEvent("DoLongHudText", src, "Race " .. pRaceName .. " created!")
end)

RPC.register("srp-racing:isRaceNameTaken", function(src, pRaceName)
