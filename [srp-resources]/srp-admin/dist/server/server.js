!(function () {
    ...
    RPC.register('qpixel:admin:getCommandUI', async (pSource) => {
      let [pAdminNotGetCommandUI, pAdminGetCommandUI] =
          exports['srp-admin'].isAdministrator(pSource),
        pObjectModuleTable = []
      return (
        Object.entries([
          {
          ...
          },
          {
            ...
            adminMenu: {
              command: {
                ...
                cat: 'Utility',
                child: false,
                action: 'srp-admin/client/select-spawn',
              },
              options: { bindKey: void 0 },
            },
          },
    ...
    onNet('playerDropped', async () => {
      let pSource = source
      let [cid, fullname] = exports['srp-admin'].getEverything(pSource)
    ...
    RPC.register('qpixel:admin:getPlayerData', (pSource) => {
      return (
        exports['srp-admin'].getEverything()
      )
    })
    RPC.register('qpixel:admin:getBanHistory', (pSource) => {
      let banHistoryPacked = exports['srp-admin'].getBanList()
    ...
    onNet('qpixel:admin:giveLicense', async (pTarget, pType) => {
      ...
      return (
        ...
        exports['srp-admin'].giveLicense(Number(pTarget), pType)
    ...
    onNet(
      ...
      async (pTarget, pJob, pRank) => {
        ...
        return (
          ...
          exports['srp-admin'].giveJobWhitelist(
            Number(pTarget),
            pJob,
            pRank
          )
    ...
    onNet('qpixel:admin:giveCash', async (pTarget, pAmount) => {
      ...
      return (
        ...
        exports['srp-admin'].giveCash(Number(pTarget), pAmount)
    ...
    onNet('qpixel:admin:createBusiness', async (pBID, pBusinessName, pBusinessOwner) => {
      ...
      exports['srp-admin'].sendLog(
        ...
        '255',
        '[srp-admin] Business Creation Log',
        'Business ID: ' +
          pBID +
          '\nBusiness Name: ' +
          pBusinessName +
    ...
    onNet('qpixel:admin:flingPlayer', async (pTarget) => {
      emitNet('srp-admin/client/fling-player', pTarget)
    })
