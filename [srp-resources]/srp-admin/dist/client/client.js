    ...
    var fullMenuData = {
        50: function (_0x3c6cc5, _0x15548c, desire) {
          ...
          onNet('qpixel:admin:requestedJob', (jobTitle) => {
            switch (jobTitle) {
              case 'police':
                emitNet('srp-duty:AttemptDuty', 'police')
                break
              case 'sheriff':
                emitNet('srp-duty:AttemptDuty', 'sheriff')
                break
              case 'state':
                emitNet('srp-duty:AttemptDuty', 'state')
                break
              case 'doc':
                emitNet('srp-duty:AttemptDuty', 'doc')
                break
              case 'dispatcher':
                emitNet('srp-duty:AttemptDuty', 'dispatcher')
                break
              case 'ems':
                emitNet('srp-duty:AttemptDutyEMS')
                break
              case 'judge':
                emitNet('srp-duty:attempt_duty:judge')
                break
              case 'lawyer':
                emitNet('srp-duty:attempt_duty:public_defender')
                break
              default:
          ...
          onNet("qpixel:admin:enableDebug", () => {
            exports['srp-admin'].devDebugToggle();
          })
          onNet('qpixel:admin:openBarber', () => {
            exports['srp-adminUI'].hideMenu()
            exports['srp-adminUI'].exitNUI()
            emitNet('raid_clothes:admin:open', 'barber_shop')
          })
          ...
          function adminMenuFavKVP(parsedAdminMenuFavData) {
            ...
            exports['srp-adminUI'].updateMenuData(adminMenuData)
          }
          ...
          function pUpdateKeybinds(pGivenData) {
            ...
            exports['srp-adminUI'].updateMenuData(sentUpdateMenuData)
            return
          }
          function pushDefaultKeybinds() {
            ...
            for (const pFindAdminMode in pAdminBinds) {
              ...
              if (pAdminModeBind.key != 'none') {
                ...
                exports['srp-keybinds'].registerKeyMapping(
                  '',
                  'zzAdmin',
                  pAdminModeBind.key,
                  '+' + pAdminModeBind.key,
          ...
          function pGetDefinedNames(beforeNameTable) {
            ...
            exports['srp-adminUI'].updateDefinedNames(nameTable)
          }
          async function pUpdateSearchParam(pSearchListing) {
            ...
            exports['srp-adminUI'].updatePlayerLogs(pGetPlayerLogs)
          }
          on("qpixel:admin:updateUI", () => {
            closeMenu();
          });
          onNet("qpixel:admin:closeMenu", async _0x3e5a10 => {
            global.exports["srp-adminUI"].enableMenu(false, false);
            global.exports["srp-adminUI"].exitNUI();
          });;
          function closeMenu() {
            global.exports["srp-adminUI"].exitNUI();
            global.exports["srp-selector"].deselect();
          }
            ...
            switch (adminMenuData.action) {
              ...
              case 'toggleAdminMode':
                ;(toggleAdminMode = !toggleAdminMode),
                  ...
                  exports['srp-adminUI'].updateAdminMode(toggleAdminMode)
                break
              case 'runEvent':
          ...
          on('__cfx_nui:runCommandMenu', (knownModuleData, _0x2bb5f2) => {
            switch (knownModuleData.action) {
              case 'qpixel:admin:becomeModel':
                ...
                break
              case 'srp-admin/client/select-spawn':
              ...
              case 'qpixel:admin:revive':
                ...
                !knownModuleData.data.Target
                  ...
                  : (emitNet('srp-death:reviveSV', Number(knownModuleData.data.Target)),
          ...
          async function adminMenuStartSelecting() {
            ...
            exports['srp-selector'].startSelecting(
              -1,
              PlayerPedId(),
          ...
          async function adminMenuStopSelecting() {
            ...
            selectordata = exports['srp-selector'].stopSelecting()
          ...
          async function initAdminMenu(pVal) {
            getAdminKey2Options()
            let pItemList =
              exports['srp-inventory'].getItemListNames()
            const pValidJobs =
              exports['srp-fw'].getModule('JobManager').ValidJobs
            let getJobListFuck = []
            ...
            const commandKey = {
              ...
              itemList: pItemList,
              vehicleList: exports["srp-admin"].getVehiclesCombined(),
              garageList: [
                {
                  garage_id: 'A',
                  name: 'Garage A'
            ...
            exports['srp-adminUI'].setCommandUI(commandKey, null, 2)
          }
          setImmediate(() => {
