...
AddEventHandler("qpixel:admin:ReviveInDistance", function()
    ...
    if playerList ~= {} and playerList ~= nil then
        ...
        for k,v in pairs(playerList) do
            TriggerServerEvent("srp-death:reviveSV", v)
...
Citizen.CreateThread( function()
  ...
  function getVehiclesCombined() 
    ...
    local vehicleTable = exports['srp-admin']:getVehicles()
    local addonVehicleTable = exports['srp-admin']:getAddonVehicles()
  ...
  RegisterNetEvent('srp-admin:InsertPrioCL')
  AddEventHandler('srp-admin:InsertPrioCL', function()
    TriggerServerEvent('srp-admin:insertPrio')
  end)