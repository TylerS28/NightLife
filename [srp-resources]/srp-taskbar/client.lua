...
function openGui(sentLength,taskID,namesent,keepWeapon)
    ...
    guiEnabled = true
    pTaskActive = 1
    exports["srp-interface"]:sendAppEvent("taskbar", {
        display = true,
        duration = sentLength,
        taskID = taskID,
        label = namesent,
...
function handheld() 
  ...
  function generalInventory()
    if not insidePrompt and not inventoryDisabled and not forceInventoryDisabled and not exports['srp-taskbar']:pInInv() then
  ...
  local function hasPhone()
    return exports["srp-inventory"]:hasEnoughOfItem("mobilephone", 1, false, true) or
        exports["srp-inventory"]:hasEnoughOfItem("stoleniphone", 1, false, true) or
        exports["srp-inventory"]:hasEnoughOfItem("stolens8", 1, false, true) or
        exports["srp-inventory"]:hasEnoughOfItem("stolennokia", 1, false, true) or
        exports["srp-inventory"]:hasEnoughOfItem("stolenpixel3", 1, false, true) or
        exports["srp-inventory"]:hasEnoughOfItem("boomerphone", 1, false, true)
  end
  ...
  function generalPhone()
    if not insidePrompt and hasPhone() and canUsePhone() then
      ...
      -- exports["srp-ui"]:openApplication("phone", {
...
Citizen.CreateThread(function()
    exports["srp-keybinds"]:registerKeyMapping("", "Radio", "Open", "+handheld", "-handheld", "I")
    RegisterCommand('+handheld', handheld, false)
    RegisterCommand('-handheld', function() end, false)
    
    exports["srp-keybinds"]:registerKeyMapping("", "Phone", "Open", "+generalPhone", "-generalPhone", "P")
    RegisterCommand('+generalPhone', generalPhone, false)
    RegisterCommand('-generalPhone', function() end, false)
    
    exports["srp-keybinds"]:registerKeyMapping("", "Inventory", "Open", "+generalInventory", "-generalInventory", "K")
    RegisterCommand('+generalInventory', generalInventory, false)
    RegisterCommand('-generalInventory', function() end, false)
    
    exports["srp-keybinds"]:registerKeyMapping("", "Player", "Escape menu", "+generalEscapeMenu", "-generalEscapeMenu", "ESCAPE")
