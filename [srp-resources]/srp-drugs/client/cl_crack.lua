...
AddEventHandler("crack:start", function()
	...
	if exports["srp-inventory"]:hasEnoughOfItem("bakingsoda",5,false) and exports["srp-inventory"]:hasEnoughOfItem("chloroform",2,false) and exports["srp-inventory"]:hasEnoughOfItem("dye",3,false) and ongoing == false then
		TriggerEvent("animation:crack")
		FreezeEntityPosition(PlayerPedId(),true)
		SetEntityHeading(PlayerPedId(), 357.96401977539)
		local finished = exports["srp-taskbar"]:taskBar(10000,"Mixing This Shit!")
...
AddEventHandler("crack:sell", function()
	if exports["srp-inventory"]:hasEnoughOfItem("1gcrack",1,false) then
...
AddEventHandler("stopmixing", function()
	if mixing == true then
      ...
      exports["srp-polytarget"]:AddBoxZone("crack_start", vector3(1092.93, -3195.72, -38.99), 1.2, 2.6, {
    heading=0
  })