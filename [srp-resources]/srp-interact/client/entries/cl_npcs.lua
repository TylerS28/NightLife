    ...
    data = {
        {
            ...
            icon = "fas fa-circle",
            event = "srp-license:purchaseBusinessLicense",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "srp-meth:purchaseMethLabKey",
        }
    },
    options = {
        distance = { radius = 1.5 },
    ...
    data = {
        {
            ...
            label = "Open Shop",
            icon = "circle",
            event = "srp-npcs:ped:openDigitalDenShop",
        }
    },
    options = {
        distance = { radius = 2.5 },
    ...
    data = {
        {
            ...
            label = "Trade",
            icon = "recycle",
            event = "srp-npcs:ped:exchangeRecycleMaterial",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(entity)
            return not IsPedAPlayer(entity) and exports["srp-polyzone"]:IsInsideEvent(entity)
        end
    }
}
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "srp-houserobberies:sell_goods",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "srp-heists:interactBobcatC4Npc",
            parameters = {},
        },
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "srp-npcs:ped:giveStolenItems",
            parameters = {}
        },
        {
            id = "pawn_sell_items",
            ...
            icon = "circle",
            event = "srp-npcs:ped:sellStolenItems",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
      {
          ...
          label = "Buy Chips",
          icon = "fas fa-circle",
          event = "srp-casino:purchaseChipsAction",
          parameters = { "purchase" }
      },
      {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "srp-casino:wheel:toggleEnable",
    },
    {
        id = "casino_wheel_spin_npc_spin",
        label = "Spin Wheel! ($500)",
        icon = "dollar-sign",
        event = "srp-casino:wheel:spinWheel",
    },
  },
  options = {
      distance = { radius = 2.5 },
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "srp-casino:purchaseMembershipCard",
        parameters = {}
    },
  },
  options = {
  ...
  data = {
    {
        ...
        icon = "fas fa-circle",
        event = "srp-casino:purchaseDrinks",
        parameters = {}
    },
  },
  options = {
    ...
    data = {
      {
          ...
          icon = "fas fa-clock",
          event = "srp-heists:checkAvailability",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
      {
          ...
          event = "srp-heists:purchaseHeistEquipment",
          parameters = {}
      },
    },
    options = {
    ...
    data = {
        {
            ...
            label = "Rent a Boat",
            icon = "circle",
            event = "srp-fishing:rentBoat",
        },
        {
            id = "fish_return",
            label = "Return the Boat",
            icon = "circle",
            event = "srp-fishing:returnBoat",
        }
    },
    options = {
        distance = { radius = 3.0 }
    ...
    data = {
        {
            ...
            label = "Get a Boat",
            icon = "circle",
            event = "srp-scuba:checkAndTakeDepo",
        }
    },
    options = {
        distance = { radius = 3.0 }
...
local validAnimalModels = {
    ...
    data = {
        {
            ...
            label = "Pet",
            icon = "fas fa-circle",
            event = "srp-interact:doPettingAnimal",
            parameters = "petting",
        },
    },
    options = {
  ...
  AddEventHandler("srp-interact:doPettingAnimal", function()
