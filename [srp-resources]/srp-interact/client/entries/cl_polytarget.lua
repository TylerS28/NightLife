    ...
    data = {
        {
            ...
            label = "Grab Drink",
            icon = "circle",
            event = "srp-stripclub:peekAction",
    ...
    data = {
        {
            ...
            label = "Clock In",
            icon = "circle",
            event = "srp-jobs:garbagestart:menu",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "car",
            event = "srp-showrooms:enterExperience",
            parameters = {}
        }
    },
    options = {
...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(entity)
            return exports['srp-boosting']:pCanUseLaptop()
        end
    }
}
    ...
    data = {
        {
            ...
            label = "Reset Garage",
            icon = "circle",
            event = "srp-garages:resetpdgarage",
            parameters = {}
        }
    },
    options = {
    ...
    data = {
        {
            ...
            icon = "circle",
            event = "srp-interact:pickupPaycheck",
            parameters = {}
        },
        { 
...
exports["srp-polytarget"]:AddBoxZone("paycheck_collect", vector3(241.65, 226.2, 106.29), 1, 1, {
    heading=340,
    minZ=102.49,
    maxZ=106.49
})

exports["srp-polytarget"]:AddBoxZone("paycheck_recipt", vector3(241.65, 226.2, 106.29), 1, 1, {
    heading=340,
    minZ=102.49,
    maxZ=106.49
})

RegisterNetEvent('srp-interact:pickupPaycheck', function()
...
exports["srp-polytarget"]:AddBoxZone("pd_shared_garage_reset", vector3(443.01, -973.6, 25.7), 2, 2, { -- PD shared reset
    heading=0,
    minZ=25.7 - 1,
    maxZ=25.7 + 1,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("mdm_craft", vector3(-1582.822, -278.280, 55.09), 2.5, 1.35, { -- Mandem Craft
    heading=282.3,
    minZ=53,
    maxZ=56,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("mango_craft", vector3(849.383, -2881.550, 11.321), 0.5, 0.5, { -- Mango Craft
    heading=268.2,
    minZ=10,
    maxZ=12,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("mango_stash", vector3(844.55,-2880.81, 11.48), 2.5, 1.35, { -- Mango Stash
    heading=175.3,
    minZ=10,
    maxZ=12,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("mat_refine", vector3(-33.868, -1040.714, 28.399), 0.5, 0.5, { -- Material Refining
    heading=68.9,
    minZ=28,
    maxZ=29,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("vpn_spot", vector3(-218.552, -1333.907, 30.759), 1.0, 1.0, { -- VPN Purchasing
    heading=267.7,
    minZ=30,
    maxZ=31,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("guerro_craft", vector3(488.184, -1966.342, 24.888), 0.5, 0.5, { -- Guerro Craft
    heading=118.2,
    minZ=24,
    maxZ=26,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("guerro_stash", vector3(489.716, -1965.143, 25.299), 1.35, 1.35, { -- Guerro Stash
    heading=38.1,
    minZ=24,
    maxZ=26,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("strokers_stash", vector3(578.49, -1870.1, 25.27), 2.4, 1, { -- Guerro Stash
    heading=335.5,
    minZ=110,
    maxZ=112,
    debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("strokers_craft", vector3(2463.16, 3452.02, 50.11), 0.6, 1.2, {-- Guerro Stash
    heading=5,
    --debugPoly=false,
    minZ=47.31,
    maxZ=51.31
...
exports["srp-polytarget"]:AddBoxZone("gang_stash", vector3(1599.06, -1669.06, 88.22), 1.6, 1, { -- Guerro Stash
    heading=20,
    --debugPoly=false
})

exports["srp-polytarget"]:AddBoxZone("gang_craft", vector3(1598.36, -1667.14, 88.22), 0.6, 1, {-- Guerro Stash
    heading=20,
    --debugPoly=false,
    minZ=85.42,
    maxZ=89.42
...
exports["srp-polytarget"]:AddBoxZone("gang2_stash", vector3(873.02, -1368.5, 26.32), 1.4, 1, { -- Guerro Stash
    heading=330,
    --debugPoly=false,
    minZ=23.52,
    maxZ=27.52
...
exports["srp-polytarget"]:AddBoxZone("gang2_craft", vector3(873.91, -1366.78, 26.32), 0.6, 1.4, { -- Guerro Stash
    heading=330,
    --debugPoly=false,
    minZ=23.32,
    maxZ=27.32
...
exports["srp-polytarget"]:AddBoxZone("gang3_stash", vector3(1609.23, 3774.43, 34.87), 1, 1, { -- black family Stash
    heading=305,
    minZ=34.87-1,
    maxZ=34.87+1
    --debugPoly=false
...
exports["srp-polytarget"]:AddBoxZone("gang3_craft", vector3(1607.63, 3776.36, 34.69), 1, 1, { -- Guerro Stash
    heading=305,
    --debugPoly=false,
    minZ=34.87-1,
    maxZ=34.87+1
...
exports["srp-polytarget"]:AddBoxZone("boosting_prepscratch", vector3(471.6, -1311.0, 29.22), 0.5, 0.5, {-- Guerro Stash
    heading=25,
    --debugPoly=false,
    minZ=25.62,
    maxZ=29.62
...
exports["srp-polytarget"]:AddBoxZone("maldinis_fridge", vector3(805.79, -761.75, 26.78), 1, 1, {
    heading=0,
    --debugPoly=false,
    minZ=24.18,
    maxZ=28.18
...
exports["srp-polytarget"]:AddBoxZone("jewdragon", vector3(-697.7, -904.69, 19.52), 1.0, 1.2, {
    heading=0,
    --debugPoly=false,
    minZ=15.92,
    maxZ=19.92
...
exports["srp-polytarget"]:AddCircleZone("galleryring",  vector3(-463.01, 47.58, 46.23), 0.35, {
    useZ = true
})

exports["srp-polytarget"]:AddBoxZone("prison_slushy",  vector3(1777.91, 2560.06, 45.67), 0.6, 1.6, {
    minZ=45.47,
    maxZ=46.67
})
