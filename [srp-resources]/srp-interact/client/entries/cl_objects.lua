...
Entries[#Entries + 1] = {
    ...
    options = {
        ...
        isEnabled = function(pEntity, pContext)
            return not exports['srp-fuel']:hasNozle()
        end
    }
}
...
Entries[#Entries + 1] = {
    ...
    options = {
        distance = { radius = 1.7 },
        isEnabled = function(pEntity, pContext)
            return exports['srp-fuel']:hasNozle()
        end
    }
}
...
--             label = "Smoke Machine",
--             icon = "circle",
--             event = "srp-stripclub:smokemachine",
--             parameters = {}
--         }
--     },
--     options = {
  ...
  data = {
      {
          ...
          icon = "archive",
          event = "srp-beekeeping:checkBeehive",
          parameters = {}
      }
  },
  options = {
  ...
  data = {
      {
          ...
          event = "srp-beekeeping:harvestHive",
          parameters = {}
      }
  },
  options = {
