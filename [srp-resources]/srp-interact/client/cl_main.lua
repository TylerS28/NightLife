...
function StartPeekin()
    ...
    UpdateRequired = true
    NearZones = {}
    nearbyZones = exports["srp-polytarget"]:GetZones(GetEntityCoords(PlayerPedId())) or {}
...
RegisterNetEvent("srp-target:changed", function(pTarget, pEntityType, pEntityOffset)
...
RegisterNetEvent('srp-polyzone:enter', function(zoneName, zoneData, zoneCenter)
...
RegisterNetEvent('srp-polyzone:exit', function(zoneName)
    if not PeekEntries['polytarget'][zoneName] then return end
