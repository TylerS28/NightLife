...
Citizen.CreateThread(function()
	...
	RPC.register('srp-houserobbery:enter_property', function(source, ...)
		local cb = {x,y,z,num}
		return cb
	end)	
...
RegisterServerEvent('srp-activities:givePayout')
AddEventHandler('srp-activities:givePayout', function(amount, pType, text)
    local src = source
