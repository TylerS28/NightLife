...
TriggerEvent("srp-hud:pursuit_values", SelectedPursuitMode)
SendNUIMessage({action = "pursuitmode", pursuitmode = SelectedPursuitMode})

 ]]
Citizen.CreateThread(function()
    exports["srp-keybinds"]:registerKeyMapping("", "Pursuit Modes", "Change Mode", "pursuit", "")
end)
