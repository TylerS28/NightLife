...
function DPX.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('srp-fw:sv:player_control_set',DPX.Controls.Current)
...
RegisterNetEvent("srp-fw:cl:player_control")
AddEventHandler("srp-fw:cl:player_control", function(controlTable)
...
RegisterNetEvent('srp-fw:setcontrols')
AddEventHandler('srp-fw:setcontrols', function()
	TriggerServerEvent('srp-fw:sv:player_controls')
end)
