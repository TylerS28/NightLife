...
local function AddMethod(player)
    ...
    function player.networkVar(self, var, data)
        ...
        TriggerClientEvent("srp-fw:networkVar", GetUser(self):getVar("source"), var, data)
    end
...
local pos = {}
RegisterServerEvent('srp-fw:updatecoords')
AddEventHandler('srp-fw:updateCoords', function(x,y,z)
    local src = source
    pos[src] = {x,y,z}
end)
...
AddEventHandler("playerDropped", function(reason)
    ...
    TriggerEvent('srp-fw:playerDropped', src, user)
end)
...
RegisterServerEvent('srp-fw:logDeath')
AddEventHandler('srp-fw:logDeath', function(killer, reason)
    local src = source
