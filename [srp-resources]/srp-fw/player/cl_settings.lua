...
function DPX.SpawnManager.Initialize(self)
    Citizen.CreateThread(function()
        ...
        TriggerEvent("srp-fw:spawnInitialized")
        TriggerServerEvent("srp-fw:spawnInitialized")
...
AddEventHandler("srp-fw:firstSpawn", function()
...
RegisterNetEvent('srp-fw:clearStates')
AddEventHandler('srp-fw:clearStates', function()
...
function DPX.SettingsData.setSettingsTable(settingsTable, shouldSend)
  if settingsTable == nil then
    ...
    TriggerServerEvent('srp-fw:sv:player_settings_set',DPX.Settings.Current)
...
RegisterNetEvent("srp-fw:cl:player_settings")
AddEventHandler("srp-fw:cl:player_settings", function(settingsTable)
  DPX.SettingsData.setSettingsTable(settingsTable,false)
end)


RegisterNetEvent("srp-fw:cl:player_reset")
AddEventHandler("srp-fw:cl:player_reset", function(tableName)
