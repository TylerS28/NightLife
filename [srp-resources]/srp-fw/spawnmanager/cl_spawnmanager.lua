...
function DPX.SpawnManager.InitialSpawn(self)
    Citizen.CreateThread(function()
        ...
        if new then TriggerEvent("srp-fw:newCharacterSpawned") DoScreenFadeIn(500) end
...
-- RegisterNetEvent("srp-fw:newCharacterSpawned")
-- AddEventHandler('srp-fw:newCharacterSpawned', function()
--     DestroyAllCams(true)
--     TriggerEvent("raid_clothes:defaultReset")
--     FreezeEntityPosition(PlayerPedId(), false)
-- end)

RegisterNetEvent("srp-fw:firstSpawn")
