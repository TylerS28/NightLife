...
RegisterNetEvent("srp-editor:buildName")
AddEventHandler("srp-editor:buildName", function(name, objects)
    if objects then
...
RegisterNetEvent("srp-editor:destroyName")
AddEventHandler("srp-editor:destroyName", function(name)
    cleanUpArea(name)
