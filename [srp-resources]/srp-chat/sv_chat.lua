...
RegisterServerEvent('srp-chat:me:Log')
AddEventHandler('srp-chat:me:Log', function(text)
    local src = source
    local user = exports["srp-fw"]:getModule("Player"):GetUser(src)
