...
RegisterNetEvent("srp-interface:open-application")
AddEventHandler("srp-interface:open-application", openApplication)
...
function closeApplication(app, data)
  ...
  TriggerEvent("srp-interface:application-closed", app, { fromEscape = false })
end
...
RegisterNetEvent("srp-interface:soundPlay")
AddEventHandler("srp-interface:soundPlay", function(name, volume, loop)
