...
RegisterNetEvent("srp-dirtymoney:allowDirtyMoneyDrops")
AddEventHandler("srp-dirtymoney:allowDirtyMoneyDrops", function()
...
RegisterNetEvent("srp-dirtymoney:attemptDirtyMoneyDrops")
AddEventHandler("srp-dirtymoney:attemptDirtyMoneyDrops", function()
	if DropOffTime == 0 then
		TriggerEvent('srp-dirtymoney:allowDirtyMoneyDrops')
		--TriggerServerEvent('mobdelivery:checkjob')
		--TriggerServerEvent("srp-dirtymoney:alterDirtyMoney", "TurnToCash", 0)
	else
...
if DirtyMoney >= amount then
	local pos = GetEntityCoords(PlayerPedId())
		...
		TriggerServerEvent("srp-dirtymoney:alterDirtyMoney","ItemDrop",amount)
