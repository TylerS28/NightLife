-- TriggerEvent("srp-props:attachProp", flagProp, 24818, -0.25, -0.25, 0.0, 180.0, 90.0, 0.0)
...
AddEventHandler("srp-props:attachProp", function(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
  attachProp(attachModelSent, boneNumberSent, x, y, z, xR, yR, zR, keepOtherProps, altVertex, name)
end)
AddEventHandler("srp-props:removeProp", function()
  removeAttachedProp()
end)
AddEventHandler("srp-props:removePropByName", function(pName)
