...
function SpawnVehicle(vehicle, pGarage, Fuel, customized, plate, IsViewing)
    ...
    if exports['srp-menu']:houseGarageCoords() ~= nil and exports['srp-menu']:NearHouseGarage() and exports['srp-menu']:NearHouseGarage2() then
        HousingSpawn = exports['srp-menu']:houseGarageCoords()
	...
	Citizen.CreateThread(function()			
        ...
        --RPC.execute("srp-wheelfitment_sv:getfuckingdata",veh, plate)
