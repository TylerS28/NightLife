...
exports['srp-ui']:openApplication('textbox', {
    callbackUrl = 'srp-ui:scenes:input', -> callbackUIName
    key = 1,
    items = {
        {
...
RegisterUICallback("srp-ui:scenes:input", function(data, cb)
    ...
    local data = {
        {
            ...
            key = true,
            children = {
				{ title = "Confirm Purchase", action = "srp-ui:wheelchairPurchase", key = true }, -> action is name of UICallback
			},
        },
    }
...
RegisterUICallback("srp-ui:wheelchairPurchase", function(data, cb)
...
####
exports["srp-ui"]:taskBarSkill(timer, skillGapSent)
####
...
###
exports["srp-ui"]:sendAppEvent("game", {
    modeDev = true / false,
